...
<head>
    <!-- Title -->
    <title>Verify Your Email Address | El' Mio</title>
    ...
    <!-- Template -->
    <link rel="stylesheet" href="<?php echo base_url()?>asset/css/graindashboard.css">
</head>
				...
				<div class="row justify-content-md-center">
					<div class="card-wrapper col-12 col-md-6 mt-5">
						<div class="brand text-center mb-3">
							<a href="main.php"><img src="<?php echo base_url()?>assets/img/logo.png"></a>
						</div>
						<div class="card">
							<div class="card-body">
