        ...
        <div class="py-4 px-3 px-md-4">
            <div class="card mb-3 mb-md-4">
                ...
                <div class="card-body">
                    ...
                    <!-- Form -->
                    <div>
                        <form action="../controllers/proses.php?aksi=tambah_user" method="POST">
                            <div class="form-row">
                                <div class="form-group col-12 col-md-6">
                                    <label for="name">Name</label>
                                    <input type="text" class="form-control" value="" id="name" name="name" placeholder="Username">
                                </div>
                                <div class="form-group col-12 col-md-6">
                            ...
                            <div class="form-row">
                                <div class="form-group col-12 col-md-12">
                                    ...
                                    <input type="password" class="form-control" value="" id="password" name="password" placeholder="Add Password">
                                </div>
                            </div>
