                ...
                <div class="card-body">
                    ...
                    <div class="table-responsive-xl">
                        <table class="table text-nowrap mb-0">
                            ...
                            <tbody>
                                <?php foreach ($db->tampil_data_user() as $user) { ?>
                                <tr>
                                    <td class="py-3"><?php echo $user['idUser']; ?></td>
                                    ...
                                    <td class="py-3"><?php echo $user['registration_date']; ?></td>
                                    <td class="py-3">
                                        <div class="position-relative">
                                            <a class="link-dark d-inline-block"
                                                href="users_edit.php?id=<?php echo $user['idUser']; ?>&aksi=edit_user">
                                                <i class="gd-pencil icon-text"></i>
                                            </a>
                                            <a class="link-dark d-inline-block"
                                                href="../controllers/proses.php?id=<?php echo $user['idUser']; ?>&aksi=delete_user">
