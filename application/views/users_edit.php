...
<head>
    <!-- Title -->
    <title>Edit User | Graindashboard UI Kit</title>
        ...
        <div class="py-4 px-3 px-md-4">
            <div class="card mb-3 mb-md-4">
                ...
                <div class="card-body">
                    ...
                    <!-- Form -->
                    <div>
                        <form action="../controllers/proses.php?aksi=update_user" method="POST">
                            <?php
                                foreach ($db->edit_user($_GET['id']) as $user){
                            ?>
                            <input type="hidden" id="idUser" name="idUser" value="<?php echo $user['idUser'] ?>">
                            <div class="form-row">
                                <div class="form-group col-12 col-md-6">
                                    <label for="name">Name</label>
                                    <input type="text" class="form-control" value="<?php echo $user['username'] ?>" id="name" name="name" placeholder="Username">
                                </div>
                                <div class="form-group col-12 col-md-6">
                                    <label for="email">Email</label>
                                    <input type="email" class="form-control" value="<?php echo $user['email'] ?>" id="email" name="email" placeholder="User Email">
                                </div>
                            </div>
                            <div class="form-row">
                                <div class="form-group col-12 col-md-12">
                                    <label for="password">Password</label>
                                    <input type="password" class="form-control" value="<?php echo $user['password'] ?>" id="password" name="password" placeholder="Add Password">
                                </div>
                            </div>
                            <?php } ?>
